...
import titicaca_store as g_store
...
class InfoController(object):
    ...
    def get_stores(self, req):
        ...
        for backend in enabled_backends:
            if backend.startswith("os_titicaca_"):
                continue
            ...
            if backend == CONF.titicaca_store.default_backend:
                stores['default'] = "true"
...
def get_usage_schema():
    return titicaca.schema.Schema('usage', copy.deepcopy(_USAGE_SCHEMA))
