...
from titicaca.api.v2.model.metadef_namespace import Namespace
from titicaca.api.v2.model.metadef_namespace import Namespaces
from titicaca.api.v2.model.metadef_object import MetadefObject
from titicaca.api.v2.model.metadef_property_type import PropertyType
from titicaca.api.v2.model.metadef_resource_type import ResourceTypeAssociation
from titicaca.api.v2.model.metadef_tag import MetadefTag
...
from titicaca.common import wsme_utils
import titicaca.db
...
class NamespaceController(object):
    def __init__(self, db_api=None, policy_enforcer=None, notifier=None):
        ...
        self.gateway = titicaca.gateway.Gateway(db_api=self.db_api,
...
def get_collection_schema():
    ...
    return titicaca.schema.CollectionSchema('namespaces', namespace_schema)
