...
class ProtectedImageFactoryProxy(titicaca.domain.proxy.ImageFactory):
...
class ProtectedImageRepoProxy(titicaca.domain.proxy.Repo):
...
class ProtectedImageProxy(titicaca.domain.proxy.Image):
...
class ExtraPropertiesProxy(titicaca.domain.ExtraProperties):
