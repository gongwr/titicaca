...
class ContextMiddleware(BaseContextMiddleware):
    ...
    def process_request(self, req):
        ...
        Generate a titicaca.context.RequestContext object from the available
    ...
    def _get_anonymous_context(self):
        ...
        return titicaca.context.RequestContext(**kwargs)
    ...
    def _get_authenticated_context(self, req):
        ...
        ctxt = titicaca.context.RequestContext.from_environ(req.environ,
                                                          **kwargs)

        # FIXME(jamielennox): titicaca has traditionally lowercased its roles.
...
class UnauthenticatedContextMiddleware(BaseContextMiddleware):
    def process_request(self, req):
        ...
        req.context = titicaca.context.RequestContext(**kwargs)
