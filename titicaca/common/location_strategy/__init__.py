...
serve the image's data. Titicaca then retrieves the image data
...
the order they are stored in Titicaca. The ``store_type`` value
...
def _load_strategies():
    ...
    modules = {}
    namespace = "titicaca.common.image_location_strategy.modules"
...
# TODO(kadachi): Not used but don't remove this until titicaca_store
