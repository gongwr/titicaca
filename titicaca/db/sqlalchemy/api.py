...
from titicaca.db.sqlalchemy.metadef_api import (resource_type
                                              as metadef_resource_type_api)
from titicaca.db.sqlalchemy.metadef_api import (resource_type_association
                                              as metadef_association_api)
from titicaca.db.sqlalchemy.metadef_api import namespace as metadef_namespace_api
from titicaca.db.sqlalchemy.metadef_api import object as metadef_object_api
from titicaca.db.sqlalchemy.metadef_api import property as metadef_property_api
from titicaca.db.sqlalchemy.metadef_api import tag as metadef_tag_api
from titicaca.db.sqlalchemy import models
from titicaca.db import utils as db_utils
from titicaca.i18n import _, _LW, _LI, _LE
...
def _image_get_staging_usage_by_owner(owner, session):
    ...
    # Images with non-empty os_titicaca_importing_to_stores properties
    ...
    props = session.query(models.ImageProperty).filter(
        models.ImageProperty.name == 'os_titicaca_importing_to_stores',
