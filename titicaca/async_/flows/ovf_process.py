...
class _OVF_Process(task.Task):
    ...
    Titicaca image store. It also parses the included OVF file for selected
    ...
    def _get_extracted_file_path(self, image_id):
        ...
        if CONF.enabled_backends:
            file_path = getattr(
                CONF, 'os_titicaca_tasks_store').filesystem_store_datadir
    ...
    def execute(self, image_id, file_path):
        """
        :param image_id: Id to use when storing extracted image to Titicaca
