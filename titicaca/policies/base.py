...
# FIXME(lbragstad): These are composite check strings that represents titicaca's
...
# cleanup to do in different parts of titicaca to sweep all the authorization
