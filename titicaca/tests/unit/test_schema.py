...
class TestBasicSchema(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = titicaca.schema.Schema('basic', properties)
...
class TestBasicSchemaLinks(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = titicaca.schema.Schema('basic', properties, links)
...
class TestPermissiveSchema(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.schema = titicaca.schema.PermissiveSchema('permissive', properties)
...
class TestCollectionSchema(test_utils.BaseTestCase):
    ...
    def test_raw_json_schema(self):
        ...
        item_schema = titicaca.schema.Schema('mouse', item_properties)
        collection_schema = titicaca.schema.CollectionSchema('mice', item_schema)
        expected = {
            'name': 'mice',
            'properties': {
                'mice': {
