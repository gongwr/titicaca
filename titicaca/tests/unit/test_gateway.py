...
class TestGateway(test_utils.BaseTestCase):
    ...
    @mock.patch('titicaca.domain.TaskExecutorFactory')
    ...
    @mock.patch('titicaca.api.policy.ImageRepoProxy')
    ...
    @mock.patch('titicaca.common.property_utils.PropertyRules._load_rules')
    ...
    @mock.patch('titicaca.api.policy.ImageFactoryProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefNamespaceRepoProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefNamespaceFactoryProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefObjectRepoProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefObjectFactoryProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefResourceTypeRepoProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefResourceTypeFactoryProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefPropertyRepoProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefPropertyFactoryProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefTagRepoProxy')
    ...
    @mock.patch('titicaca.api.policy.MetadefTagFactoryProxy')
    ...
    @mock.patch('titicaca.api.policy.ImageMemberRepoProxy')
    ...
    @mock.patch('titicaca.api.policy.ImageMemberFactoryProxy')
    ...
    @mock.patch('titicaca.api.policy.TaskRepoProxy')
    ...
    @mock.patch('titicaca.api.policy.TaskFactoryProxy')
    ...
    @mock.patch('titicaca.api.policy.TaskStubRepoProxy')
