...
from titicaca.api.v2 import metadef_namespaces as namespaces
from titicaca.api.v2 import metadef_objects as objects
from titicaca.api.v2 import metadef_properties as properties
from titicaca.api.v2 import metadef_resource_types as resource_types
from titicaca.api.v2 import metadef_tags as tags
...
class TestMetadefsControllers(base.IsolatedUnitTest):
    ...
    @mock.patch('titicaca.api.v2.metadef_namespaces.LOG')
    def test_cleanup_namespace_success(self, mock_log):
        fake_gateway = titicaca.gateway.Gateway(db_api=self.db,
    ...
    @mock.patch('titicaca.api.v2.metadef_namespaces.LOG')
    @mock.patch('titicaca.api.authorization.MetadefNamespaceRepoProxy.remove')
