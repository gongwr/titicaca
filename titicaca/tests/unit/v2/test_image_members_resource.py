...
import titicaca.api.v2.image_members
...
def _domain_fixture(id, **kwargs):
    ...
    return titicaca.domain.ImageMembership(**properties)
...
class TestImageMembersController(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.controller = titicaca.api.v2.image_members.ImageMembersController(
            self.db,
            self.policy,
            self.notifier,
            self.store)
...
class TestImageMembersSerializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.serializer = titicaca.api.v2.image_members.ResponseSerializer()
        self.fixtures = [
...
class TestImagesDeserializer(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.deserializer = titicaca.api.v2.image_members.RequestDeserializer()
