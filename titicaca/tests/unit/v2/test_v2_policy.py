...
from titicaca.api.v2 import policy
...
class APIImagePolicy(APIPolicyBase):
    ...
    @mock.patch('titicaca.api.policy._enforce_image_visibility')
    ...
    def test_delete_locations_falls_back_to_legacy(self):
        ...
        with mock.patch('titicaca.api.v2.policy.check_is_image_mutable') as m:
            self.policy.delete_locations()
    ...
    def test_add_image_falls_back_to_legacy(self):
        ...
        with mock.patch('titicaca.api.v2.policy.check_admin_or_same_owner') as m:
            self.policy.add_image()
