...
class TestStagingStoreHousekeeping(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        titicaca_store.register_store_opts(
            CONF,
            reserved_stores={'os_titicaca_staging_store': 'file'})
        ...
        titicaca_store.create_multi_stores(
            CONF,
            reserved_stores={'os_titicaca_staging_store': 'file'})
    ...
    @mock.patch('titicaca.common.store_utils.get_dir_separator')
