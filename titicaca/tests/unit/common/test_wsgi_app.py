...
class TestWsgiAppInit(test_utils.BaseTestCase):
    ...
    def test_wsgi_init_sets_thread_settings(self, mock_config_files,
        ...
        mock_load.assert_called_once_with('titicaca-api')
    ...
    @mock.patch('titicaca.housekeeping.StagingStoreCleaner')
    ...
    @mock.patch('titicaca.image_cache.prefetcher.Prefetcher')
