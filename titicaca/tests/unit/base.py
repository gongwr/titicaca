...
from titicaca_store._drivers import rbd as rbd_store
...
from titicaca.tests import stubs
    ...
    def setUp(self):
        ...
        def fake_get_conection_type(client):
            ...
            if client.port == DEFAULT_API_PORT:
                return stubs.FakeTiticacaConnection

        self.patcher = mock.patch(
            'titicaca.common.client.BaseClient.get_connection_type',
