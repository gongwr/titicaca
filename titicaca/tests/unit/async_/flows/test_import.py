...
import titicaca.async_.flows.base_import as import_flow
...
class TestImportTask(test_utils.BaseTestCase):
    ...
    def test_import_to_fs(self):
        ...
        with mock.patch.object(script_utils, 'get_image_data_iter') as dmock:
            ...
            with mock.patch.object(putils, 'trycmd') as tmock:
                ...
                reader, size = titicaca_store.get_from_backend(path)
    ...
    def test_delete_from_fs(self):
        ...
        store = titicaca_store.get_store_from_scheme('file')
        path = titicaca_store.store_add_to_backend(mock.sentinel.image_id, data,
