...
from titicaca.async_.flows import ovf_process
...
class TestOvfProcessTask(test_utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        # The titicaca/tests/var dir containing sample ova packages used
    ...
    def test_ovf_process_no_config_file(self, mock_find_file):
        # Mimics a Titicaca deployment without the ovf-metadata.json file
