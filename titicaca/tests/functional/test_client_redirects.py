...
"""Functional test cases testing titicaca client redirect-following."""
...
from titicaca.common import client
...
def RedirectTestApp(name):
    class App(object):
        ...
        redirects and is used to verify Titicaca client redirects.
        """
        def __init__(self):
            """
