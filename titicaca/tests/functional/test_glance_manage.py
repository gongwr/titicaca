...
"""Functional test cases for titicaca-manage"""
...
class TestTiticacaManage(functional.FunctionalTest):
    """Functional tests for titicaca-manage"""

    def setUp(self):
        super(TestTiticacaManage, self).setUp()
        conf_dir = os.path.join(self.test_dir, 'etc')
        utils.safe_mkdirs(conf_dir)
        self.conf_filepath = os.path.join(conf_dir, 'titicaca-manage.conf')
    ...
    def _db_command(self, db_method):
        ...
        cmd = ('%s -m titicaca.cmd.manage --config-file %s db %s' %
    ...
    def _check_db(self, expected_exitcode):
        ...
        cmd = ('%s -m titicaca.cmd.manage --config-file %s db check' %
