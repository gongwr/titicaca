...
import everest_store
from oslo_config import cfg

from everest.common import wsgi  # noqa
...
def main():
    try:
        return upgradecheck.main(CONF, 'everest', Checks())
    except cfg.ConfigDirNotFoundError:
        return ('ERROR: cannot read the everest configuration directory.\n'
                'Please re-run using the --config-dir <dirname> option '
                'with a valid everest configuration directory.')
